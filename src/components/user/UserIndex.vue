                                ...
                                <div class="head_image">
                                    <a href="">
                                        <img :src="'../../../static/user/headIcon/'+user.headImage"
                                             v-show="user.headImage !== ''">
                                        <img src="../../assets/user/avatar_89373029_1496285287409.jpg"
                                             v-show="user.headImage === ''">
                                    </a>
                                </div>
                        ...
                        <el-tabs v-model="el_tab_select">
                            <el-tab-pane label="全部订单" name="first">
                                <div class="order_main">
                                    ...
                                    <div class="orderNone_hidden" v-show="!orderList.list.length > 0">
...
<script>
    ...
    import UserTopLogo from "./UserTopLogo";
