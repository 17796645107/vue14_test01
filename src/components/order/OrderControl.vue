                ...
                <div class="order_warp">
                    <table>
                        ...
                        <tr class="order_detail" v-for="(detail,index) in order.goodCartList">
                            <td>
                                <img :src="'../../../static/product/'+detail.product.defaultImage.image" alt="">
                                <div class="order_product">
                                    <p>{{detail.product.title}}</p>
                                    <p>{{detail.product_color}} {{detail.product_size}}</p>
                                </div>
                            </td>
                            <td v-show="index === 0" :rowspan="order.goodCartList.length"><strong>¥{{order.productTotal}}</strong>
                            </td>
                    ...
                    <div class="page">
                        <ul>
                            <li :class="{ban:orderList.isFirstPage,notBan:!orderList.isFirstPage}"
                                @click="getOrderPageByUserID(orderList.list[0].user_id,orderList.prePage)"><
                            </li>
                            ...
                            <li :class="{ban:orderList.isLastPage,notBan:!orderList.isLastPage}"
                                @click="getOrderPageByUserID(orderList.list[0].user_id,orderList.nextPage)">>
                            </li>
                        </ul>
